...
const GridAndSpacingPage = props => (
  <MainLayout {...props}>
...
`}
      ...
      >
        <p>
          ...
          content that has display: block and a width set—by setting the
      ...
      <p>
        ...
        <code>padding</code> cannot). As of 4.2, we’ve added negative margin
        utilities for every non-zero integer size listed above (e.g.,{" "}
        <code>1</code>, <code>2</code>, <code>3</code>, <code>4</code>,{" "}
        <code>5</code>). These utilities are ideal for customizing grid column
        gutters across breakpoints.
      </p>
      <p>
        The syntax is nearly the same as the default, positive margin utilities,
        but with the addition of n before the requested size. Here’s an example
        class that’s the opposite of <code>.mt-1</code>:
      </p>
      <div class="highlight">
...
export default GridAndSpacingPage
