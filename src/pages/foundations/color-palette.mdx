...
<article id="main" className="pr-3">
  ...
  <footer className="mt-4 pt-3">
    <div className="d-xl-none">
      <h5 className="pt-2">More Information</h5>
      <a
        href="https://modus.trimble.com/foundations/color-palette/"
        className="nav-link text-dark text-decoration-none ml-0 pl-0 filter-desaturate"
        target="_blank"
        rel="noopener"
      >
        Modus Style Guide
    ...
    <span className="text-secondary small">
      <i> Last updated December 8, 2021. </i>
    </span>
  </footer>
</article>
