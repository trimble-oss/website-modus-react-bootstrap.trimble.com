...
const FlexPage = props => (
  <MainLayout {...props}>
    ...
    <CodeBlock
      code={`
<div className="d-flex p-2 highlighted">I'm a flexbox container!</div>
`}
    >
    ...
    <CodeBlock
      code={`
<div className="d-inline-flex p-2 highlighted">I'm an inline flexbox container!</div>
`}
    ></CodeBlock>
    <p>
...
`}
    >
      <p>
        ...
        browser default is <code>row</code>. However, you may encounter
      ...
      <p>
        ...
        default), or
        <code>.flex-row-reverse</code> to start the horizontal direction from
        the opposite side.
      </p>
    </CodeBlock>
...
`}
    >
      <p>
        ...
        <code>.flex-column-reverse</code> to start the vertical direction from
        the opposite side.
      </p>
    </CodeBlock>
  ...
  <div className="d-flex justify-content-around">...</div>
    ...
    >
      <p>
        ...
        start, y-axis if <code>flex-direction: column</code>). Choose from{" "}
...
<div className="d-flex bd-highlight">
  ...
  <div className="p-2 bd-highlight">Third flex item</div>
    ...
    >
      <p>
        Use <code>.flex-grow-*</code> utilities to toggle a flex item’s ability
        to grow to fill available space. In the example below, the{" "}
  ...
  <div className="p-2 flex-shrink-1 bd-highlight">Flex item</div>
    ...
    >
      <p>
        ...
        ability to shrink if necessary. In the example below, the second flex
        item with <code>.flex-shrink-1</code> is forced to wrap its contents to
        a new line, “shrinking” to allow more space for the previous flex item
        with <code>.w-100</code>.
      </p>
    </CodeBlock>
  ...
  <div className="d-flex highlighted mb-3">
    ...
    >
      <p>
        ...
        with auto margins. Shown below are three examples of controlling flex
        items via auto margins: default (no auto margin), pushing two items to
        the right (<code>.mr-auto</code>), and pushing two items to the left (
        <code>.ml-auto</code>).
      </p>
      <p>
        <strong>
          Unfortunately, IE11 does not properly support auto margins on flex
          items whose parent has a non-default
        </strong>{" "}
...
`}
    >
      <p>
        ...
        and <code>margin-top: auto</code> or <code>margin-bottom: auto</code>.
      </p>
    </CodeBlock>
  ...
  ...
    ...
    >
      <p>
        ...
        with <code>.flex-wrap</code>, or reverse wrapping with{" "}
...
`}
    >
      <p>
        ...
        flex items together on the cross axis. Choose from start (browser
        default), <code>end</code>, <code>center</code>, <code>between</code>,{" "}
