                ...
                <div className="px-4">
                  <div className="card-home">
                    <p className="card-text px-xl-3">
                      Download from npm, CDN and find out how to use with React
                      projects.
                    </p>
                  </div>
                  <div className="mt-1">
            ...
            <div className="col mb-5">
              <div className="h-100">
                ...
                <div className="px-4">
                  <div className="card-home">
                    <p className="card-text px-xl-3">
                      An optional responsive app layout you can use for your web
                      applications.
                    </p>
                  </div>
                  <a
            ...
            <div className="col mb-5">
              <div className="h-100">
                ...
                <div className="px-4">
                  <div className="card-home">
                    <p className="card-text px-xl-3">
                      Typography, Color Palette, Depth, Grid &amp; Spacing and
                      Icons.
                    </p>
                  </div>
                  <a
            ...
            <div className="col mb-5">
              <div className="h-100">
                ...
                <div className="px-5">
                  <div className="card-home">
                    <p className="card-text px-xl-3">
                      Utility classes are a powerful ally in combatting CSS
                      bloat and poor page performance.
                    </p>
                  </div>
                  <a
            ...
            <div className="col mb-5">
              <div className="h-100">
                ...
                <div className="px-4">
                  <div className="card-home">
                    <p className="card-text px-xl-3">
                      Subscribe to the mailing list and be the first to find out
                      about new releases.
                    </p>
                  </div>
                  <a
