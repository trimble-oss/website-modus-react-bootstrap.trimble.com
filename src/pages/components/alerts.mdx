...
<CodeBlock title="Basic Alerts" code={basicAlert}></CodeBlock>

<CodeBlock title="Alerts with Links" code={alertWithLink}>
  For links, use the <code>&lt;Alert.Link&gt;</code> component to provide
  matching colored links within any alert.
</CodeBlock>

<CodeBlock title="Alerts with Buttons" code={alertWithButton}></CodeBlock>

<CodeBlock title="Dismissible Alerts" code={dismissibleAlert}>
