...
<Overview>
  ...
  available links. Use a wrapping <code>&lt;nav&gt;</code> element to identify
  ...
  <code>&lt;nav&gt;</code> to reflect its purpose. For example, if the pagination
   component is used to navigate between a set of search results, an appropriate
...
<CodeBlock title="PaginationSizing" code={PaginationSizing}>
