...
>
  ...
  shown in the example. The function accepts <code>FileList</code> object and it
  should return null or the error message. The default validation will be
...
<p>
  ...
  /<code>return</code> or <code>space</code> keys will open the default file
  picker.
</p>
