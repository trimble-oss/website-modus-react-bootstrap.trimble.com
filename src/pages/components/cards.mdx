...
<CodeBlock title="Card Example" code={CardExample}>
...
<CodeBlock title="Card with Image" code={CardWithImage}>
  To add an image to the top of the card, use <code>&lt;Card.Img&gt;</code> with
  a variant <code>top</code>.
</CodeBlock>

<CodeBlock title="Header and Footer" code={HeaderAndFooter}>
  Use <code>&lt;Card.Header&gt;, &lt;Card.Footer&gt;</code> to add header and
  footer content.
</CodeBlock>

<CodeBlock title="Customizing Cards" code={CustomizingCards}>
