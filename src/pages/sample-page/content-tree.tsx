  ...
  <div style={{ width: "400px" }}>
    <TreeView nodeId={0} id="multiselect" multiSelectCheckBox>
      ...
      <TreeViewItem nodeId={7} label="UI Elements">
        ...
        <TreeViewItem nodeId={11} label="Breadcrumbs"></TreeViewItem>
      ...
      <TreeViewItem nodeId={19} label="Configuration"></TreeViewItem>
    </TreeView>
  </div>
)

const TreeViewCondensed = () => (
  <div style={{ width: "400px" }}>
...
const TreeViewWithActionBar = () => {
  ...
  function Example() {
    ...
    function updateNodes(nodes: any[], nodeId, action) {
      ...
      ({ clientX, clientY }) => {
        ...
        if (dropNode) {
          ...
          if (
            ...
            !(
              dropNode.parentIds &&
              dropNode.parentIds.includes(draggingState.current.node.nodeId)
            )
          ) {
...
export default function ContentTreePage(props: any) {
  return (
    <div className="grid-layout">
      ...
      <Content title="Basic" content={<TreeViewBasic />} />
      <Content title="Borderless" content={<TreeViewBorderless />} />
      <Content title="Multi selection" content={<TreeViewMultiSelect />} />
      <Content title="Multi selection" content={<TreeViewCondensed />} />
      <Content title="Multi selection" content={<TreeViewWithItemIcon />} />
      <Content title="Multi selection" content={<TreeViewWithActionBar />} />
      <Content title="Multi selection" content={<TreeViewWithFilter />} />
      <Content title="Multi selection" content={<TreeViewWithDragDrop />} />
    </div>
  )
}
