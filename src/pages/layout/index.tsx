...
//Modus Layout script used only at layout page
import { ModusLayout } from "../../common/ExternalReferences"
...
div.modus-layout
      ...
      <p>
        ...
        <code>.modus-body</code> to set up the left nav area and main content
        area.
      </p>
      <p>
        After <code>.modus-body</code> should be
        <code>nav.modus-sidebar</code> which contains a vertical nav list (more
        info below).
      </p>
      <p>
      ...
      <p>
        To help illustrate how all the layout elements look when displayed we
        have this interactive example.
      </p>
      <div className="guide-example-block">
        <div
          className="guide-sample position-relative p-0 border"
          id="interactiveExample"
          style={{ height: "600px", zIndex: 10, backgroundColor: "white" }}
        >
            ...
            >
              ...
              <div className="modus-content-rows" id="modusContentRows">
                ...
                <div className="modus-content-columns" id="modusContentColumns">
                  <div
                    className="modus-panel panel-lg shadow-sm"
                    id="modusPanel"
                  >
      ...
      <div className="guide-example-block">
        <div
          className="guide-sample position-relative p-0 border"
          style={{ height: "300px", zIndex: 10, backgroundColor: "white" }}
          id="sidebarExample"
        >
          <div className="modus-layout">
      ...
      <p>
        ...
        inside your layout. Simply add <code>.modus-toolbar</code> inside
        <code>.modus-content-rows</code>.
      </p>
      <p>
        You can use our other components, such as buttons and form groups,
        inside <code>.modus-toolbar</code> to add functionality to your
        application.
      </p>
      <div className="guide-example-block">
        <div
      ...
      <p>
        ...
        layout. Simply add <code>.modus-panel</code> inside of
      ...
      <p>
        ...
        <code>.scroll-container</code> inside the <code>.panel-body</code> for
        additional functionality.
      </p>
      <p>
        <strong>Note:</strong> Modus Panels must be given a <code>width</code>{" "}
      ...
      <div className="guide-example-block">
        <div
          className="guide-sample position-relative p-0 border"
          style={{ height: "400px", zIndex: 10, backgroundColor: "white" }}
          id="example-block3"
        >
          <div className="modus-layout">
            <div className="modus-body">
